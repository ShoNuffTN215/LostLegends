...
public class ForgeOfKnowledgeMenu extends AbstractContainerMenu {
    public final ForgeOfKnowledgeBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public ForgeOfKnowledgeMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public ForgeOfKnowledgeMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.FORGE_OF_KNOWLEDGE_MENU.get(), pContainerId);
        checkContainerSize(inv, 4);
        blockEntity = ((ForgeOfKnowledgeBlockEntity) entity);
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, 9, 95, 57));
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.FORGE_OF_KNOWLEDGE.get());
    }
